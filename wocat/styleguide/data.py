...
data = {
    ...
    'institutions_table': {
        ...
        'template': 'widgets/institutions-table.html',
        'context': {
            'allcountries': 'All Countries',
            'countries': [
                { 'name': 'Germany', },
            ...
            'pages': [1,2,3,4], # Math.ceil ( Anzahl Institutions / Institutions pro Seite )
            'maxpagesize': 3, # Institutions pro Seite
            'institutions': [
                {
                    'name': 'Sinnwerkstatt',
                    'year': '1848',
                    ...
                    'contactperson': 'Eraldo mit sehr langem Namen',
                    'visible': True,
                },
                {
                    'name': 'Sinnwerkstatt mit sehr langen Namen mit sehr langen Namen',
                    'year': '1848',
                    'href': 'http://sinnwerkstatt',
                    'avatarsrc': '/static/styleguide/test-images/giraffe-1by1.jpg',
                    'country': 'Germany',
                ...
                {
                    'name': 'Sinnwerkstatt ohne Jahr',
                    'href': 'http://sinnwerkstatt',
                    'avatarsrc': '/static/styleguide/test-images/studio-1by1.jpg',
                    'logosrc': '/static/styleguide/test-images/dog-1by1.jpg',
                    'country': 'Germany',
                    'contactpersonhref': 'http://person',
                    'contactperson': 'Eraldo mit sehr langem Namen Eraldo mit sehr langem Namen Eraldo mit sehr langem Namen Eraldo mit sehr langem Namen',
                    'visible': True,
                },
                {
                    'name': 'Sinnwerkstatt ohne Link',
                    'year': '1848',
                    'avatarsrc': '/static/styleguide/test-images/silhouette-1by1.jpg',
                    'country': 'Niger',
                    'contactpersonhref': 'http://person',
